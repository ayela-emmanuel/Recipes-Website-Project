							...
							<?php
								...
								if($recipe['bool']==true){
									...
									<tr>
										...
										<td><img src="<?php echo $path['siteUrl'].'../upload/'.$recipe['img']; ?>" width="100" /></td>
										...
										<td>
											...
											<a onclick="return confirm('Are you sure to delete this?')" href="/admin/delete-recipe.php?recid=<?php echo $recipe['recipe_id']; ?>" title="Delete" class="text-red"><i class="fa fa-times"></i></a>
										</td>
									</tr>
									<?php
									}
